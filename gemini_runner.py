...
MODEL_CANDIDATES = [
    ...
    # gemini-2.0-flash-exp removed: confirmed 404 "not found for API version
    # v1beta, or is not supported for generateContent" — it's retired/doesn't
    # do image output anymore, so it was a dead fallback, not a safety net.
]
